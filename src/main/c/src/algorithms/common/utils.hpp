...
namespace logger {
  ...
  static ALWAYS_INLINE void trace(const std::string & s) {
    printf(ANSI_COLOR_YELLOW "[CUDA][LOG]Trace:: " ANSI_COLOR_RESET);
    printf("%s", s.c_str());
    printf("\n");
  }
  ...
  static ALWAYS_INLINE void debug(const std::string &s) {
    printf(ANSI_COLOR_YELLOW "[CUDA][LOG]Debug:: " ANSI_COLOR_RESET);
    printf("%s", s.c_str());
    printf("\n");
  }
  template <typename... Args>
  ...
  static ALWAYS_INLINE void verbose(const std::string &s) {
    printf(ANSI_COLOR_GREEN "[CUDA][LOG]Verbose:: " ANSI_COLOR_RESET);
    printf("%s", s.c_str());
    printf("\n");
  }
  template <typename... Args>
  ...
  static ALWAYS_INLINE void info(const std::string &s) {
    printf(ANSI_COLOR_BLUE "[CUDA][LOG]Info:: " ANSI_COLOR_RESET);
    printf("%s", s.c_str());
    printf("\n");
  }
  ...
  static ALWAYS_INLINE void error(const std::string &s) {
    printf(ANSI_COLOR_RED "[CUDA][LOG]Error:: " ANSI_COLOR_RESET);
    printf("%s", s.c_str());
    printf("\n");
  }
  template <typename... Args>
  ...
  static ALWAYS_INLINE void critical(const std::string & s) {
    printf(ANSI_COLOR_RED "[CUDA][LOG]Critical:: " ANSI_COLOR_RESET);
    printf("%s", s.c_str());
    printf("\n");
    assert(0);
  }
  ...
  static ALWAYS_INLINE void fatal(const std::string &s) {
    printf(ANSI_COLOR_RED "[CUDA][LOG]Fatal:: " ANSI_COLOR_RESET);
    printf("%s", s.c_str());
    printf("\n");
    assert(0);
  }
...
struct timer_entry {
  ...
  void log() {
    ...
    printf(ANSI_COLOR_BLUE "[CUDA][TIMER]" ANSI_COLOR_RESET " %s\n", to_print.c_str());
  }
